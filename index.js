...
// ⬇️ שלב 1: העלאת סרטון מלא לתיקיית Full_clips
    ...
    exec(ffmpegCmd, async (error) => {
      ...
      const driveRes = await uploadToDrive({
        ...
        metadata: {
          ...
          action_type: "segment_upload" // 👈 שליחה ל־Full_clips
        }
      });
...
// ⬇️ שלב 2: חיתוך קליפים אוטומטי לפי פעולות למשחק
